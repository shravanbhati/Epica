...
export default function SignUpPage() {
  ...
  async function submit(e) {
    e.preventDefault();
    setError(null);
    if (!isLoaded || isSubmitting) return null;
  ...
  async function onPressVerify(e) {
    ...
    try {
      ...
      if (completeSignUp.status !== "complete") {
        ...
        // need do to handle this case properly
      }
      if (completeSignUp.status === "complete") {
  ...
  async function signUpWithGoogle() {
    if (!isLoaded || isGoogleSubmitting) return;
    setError(null);
  ...
  async function signUpWithApple() {
    if (!isLoaded || isAppleSubmitting) return;
    setError(null);
            ...
            {!pendingVerification ? (
              <form onSubmit={submit}>
                <div className="flex flex-col gap-6 text-center">
                  <CardHeader className="px-0 text-xl">
                    <CardTitle>Welcome to Epica Studio</CardTitle>
                    <CardDescription>
              ...
              <form onSubmit={onPressVerify}>
                <div className="flex flex-col gap-6 w-xs">
                  <CardHeader className="px-0 text-xl text-center">
